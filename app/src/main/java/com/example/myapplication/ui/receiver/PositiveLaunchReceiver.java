package com.example.myapplication.ui.receiver;
            ...
            if (TRANSACTION_RESULT_EVENT.equals(intent.getAction())) {
                ...
                if (resultType != null && resultType.equals("Reports")) {
                    ...
                    if (result != null) {
                        ...
                        if (transFound && result.isTransApproved()) {
                            Log.i(TAG, "Transaction Approved. Navigating to BasketActivity...");
                            navigateToBasketActivity(context);
                        } else {
...
//                        }
    ...
    private void navigateToBasketActivity(Context context) {
...
//    }
    private void displayTransactionDetails(Context context) {
        Log.d(TAG, "Navigating to BasketActivity...");

        Intent basketIntent = new Intent(context, BasketActivity.class);
        basketIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
